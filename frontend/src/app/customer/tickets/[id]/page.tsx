...
import CustomerReplyPanel from "@/components/customer/CustomerReplyPanel";
  ...
  return (
    <div className="flex min-h-screen bg-slate-100">
      ...
      <div className="flex-1">
        <Topbar
          title="Ticket Detail"
          subtitle="View your ticket conversation and send replies."
        />
          ...
          {!ticket ? (
            ...
            <div className="grid gap-6 xl:grid-cols-3">
              <div className="space-y-6 xl:col-span-2">
                ...
                <CustomerReplyPanel ticketId={ticket.id} onRefresh={loadTicket} />
              </div>
